    ...
    return (
      <div className="grid-panels">
        ...
        >
              ...
              <div key={date}>
                ...
                >
                  ...
                  <span style={{ display: 'inline-flex', alignItems: 'baseline', gap: 8 }}>
                    <span
                      style={{ fontWeight: 600, fontSize: 19, fontVariantNumeric: 'tabular-nums' }}
                    >
                      {ratio.toFixed(1)}%
                    </span>
          ...
          <SourceLine>2025 PAFR, p. 5 · UAAL in $ thousands</SourceLine>
        </Panel>
  ...
  return (
    <div className="grid-panels">
      <Panel kicker="Retiree healthcare benefits — enrollment" title="As of June 30">
        ...
        <SourceLine>2025 PAFR, p. 6</SourceLine>
      </Panel>
